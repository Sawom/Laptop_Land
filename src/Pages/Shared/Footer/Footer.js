    ...
    return (
     <div className='mt-8' >
            <div className=' footer-center' >
                <footer style={{backgroundColor: '#212E52'}} className="footer p-10 bg-neutral text-neutral-content">
                    {/* 1st part */}
                    <div className='text-left'>
                        <p> <span className='text-2xl font-bold' >CONTACT US</span> <br/> <br />  </p>
                ...
                <footer style={{backgroundColor: '#212E52'}} className="footer footer-center p-4 bg-black text-white">
                    <div>
