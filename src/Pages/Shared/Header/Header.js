        ...
        <div>
            ...
            <div className='backgroundstyle'>
                ...
                <div className="navbar-end flex-none">
                        <ul className="menu menu-horizontal  px-1">
                        <li className='mx-2'><Link className="btn btn-sm mx-2" >Dashboard</Link></li>
                        <li> <button className="btn btn-sm mx-2">Logout</button> </li>
                        <li> <Link className="btn btn-sm mx-2">Login</Link> </li>
                        </ul>
                </div>
